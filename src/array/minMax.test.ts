...
describe("minmax function", () => {
  test("returns min and max in an array of positive numbers", () => {
    expect(minMax([1, 2, 3, 4, 5])).toEqual([1, 5]);
  });

  test("returns min and max in an array of negative numbers", () => {
    expect(minMax([-1, -2, -3, -4, -5])).toEqual([-5, -1]);
  });

  test("returns min and max in an array of mixed numbers", () => {
    expect(minMax([-2, 1, 3, -4, 5])).toEqual([-4, 5]);
  });

  test("returns min and max in an array with repeating numbers", () => {
    expect(minMax([2, 2, 2])).toEqual([2, 2]);
  });

  test("returns min and max in a single-element array", () => {
